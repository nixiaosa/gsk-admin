var page = new Vue({
    ...
    methods:{
        search_pro:function(isSearch){
            ...
            HttpUtils.requestPost("/api/live/jx_list",JSON.stringify(jsonData),function(dataResult){
        ...
        link_pro_detail:function(index){
            var uuid=this.product_datas[index].id;
            router.push({path:'live_jx_info',query:{uuid:uuid}});
        }
    },
    mounted: function () {
        var _this=this;
