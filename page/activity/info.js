var page = new Vue({
    ...
    methods: {
        ...
        save_pro_info: function (proStatus) {
            ...
            var _this = this;
            HttpUtils.requestPost("/api/activity/save", JSON.stringify(_this.pro_info), function (dataResult) {

                if (dataResult.status == 1000) {
                    
                    $.toast("保存成功!");
                    router.push({path:'activity_list',query:{uuid:''}});
                } else {
